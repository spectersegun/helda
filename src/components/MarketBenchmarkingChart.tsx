  ...
  return (
    <g transform={`translate(${x},${y})`}>
      <text
        ...
        textAnchor="middle"
        dy={18} // pushes the first line down a bit
      >
      ...
      {payload.map((p: any) => (
        <div key={p.dataKey} className="flex items-center gap-2 text-[#4A5568]">
          ...
          <span className="capitalize !min-w-[52px]">
            {p.dataKey === "hospital" ? "My Hospital" : "Industry Benchmark"}
          </span>
...
export default function MarketBenchmarkingChart() {
  return (
    <div className="w-full max-w-[491px] rounded-[24px] bg-white !p-6 shadow-[0_6px_24px_rgba(16,24,40,0.04)]">
      <MiniHeader className="max-w-[200px]">Market Benchmarking</MiniHeader>
