...
export default function PatientIntelligenceCard({
  ...
  return (
    <div
      className={[
        "relative overflow-hidden rounded-2xl bg-white text-center max-h-[26vh] h-[25.9vh] cursor-pointer opacity-0 animate-[fadeInTop_0.6s_ease-out_forwards_0.7s]",
    ...
    >
      ...
      <div className="absolute bottom-[0] left-0 right-0 !w-full !pb-1.5 flex flex-col items-center">
        ...
        <div className="text-[3.2vw] absolute bottom-[2.7vh] text-black font-medium   ">
          {/* 68% */}
